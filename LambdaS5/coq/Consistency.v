...
Definition runs_type_get_closure_preserves_all_locs_exist runs :=
  forall st e st2 res,
  all_locs_exist st ->
  runs_type_get_closure runs st e = (st2, res) ->
  superstore st st2 /\ all_locs_exist st2 /\
  result_value_loc_exists ok_loc st2 res
.
...
Definition runs_preserves_all_locs_exist runs :=
...
.
Proof.
  intros runs st st2 res e runs_eval_cstt H.
  unfold runs_preserves_all_locs_exist in runs_eval_cstt.
...
Proof.
  ...
  induction max_steps. (* TODO: no automatic naming *)
    ...
    intros st e st2 res st_cstt H.
    unfold runs_get_closure in H.
    unfold runs in H.
    eapply get_closure_preserves_all_locs_exist.
      Focus 2.
      apply st_cstt.
      ...
      unfold runs_type_get_closure_preserves_all_locs_exist.
      simpl.
      intros st0 v0 st1 res1 H'.
      apply IHmax_steps.
      apply H'.
Qed.
